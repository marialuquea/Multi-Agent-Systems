...
public class BuyerAgent extends Agent
{
	...
	{
		System.out.println("setup() in buyer, register with DF");
	...
	public class TickerWaiter extends CyclicBehaviour
	{
		...
		public void action()
		{
			...
			//System.out.println("Done/Terminate msg in buyer: "+msg);
			
			if (msg != null)
			{
				//System.out.println("Msn not null in buyer: "+msg.getContent());
				
				if (tickerAgent == null)
					tickerAgent = msg.getSender();
				if (msg.getContent().equals("new day"))
				{
					System.out.println("NewDay msg received in buyer: "+msg.getContent());
				...
				else
				{
					...
					System.out.println("Termination msg received in buyer: "+msg.getContent());
		...
		public int onEnd()
		{
			...
			for (String book : booksToBuy)
			{
				if (bestOffers.containsKey(book))
				{
					...
					//System.out.println("Offer: "+book + ", " + o.getSeller() + ", " + o.getPrice());
					System.out.println("Offer: "+book + ", " + o.getPrice());
				}
				else 
				{
	...
	public class EndDay extends OneShotBehaviour
	{
		...
		public void action()
		{
			...
			System.out.println("Done msg sent by buyer: "+msg.getContent());
			
			//send Done message to all sellers
